...
import { useResetPassword } from '@/lib/hooks/useApi'
...
function ResetPasswordForm() {
  ...
  useEffect(() => {
    ...
    if (tokenParam) {
      ...
      setError('Invalid or missing token. Request a new link from Forgot Password.')
        ...
        <div className="flex-1 flex items-center justify-center p-8">
          <div className="w-full max-w-md">
              ...
              {isLoading && (
                <div className="absolute inset-0 bg-white/80 backdrop-blur-sm rounded-2xl flex items-center justify-center z-10">
                  <div className="text-center">
                    ...
                    <p className="text-[#08163d] font-medium">Resetting Password...</p>
                  </div>
                </div>
              )}
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <Link
                        ...
                        className="text-sm text-[#08163d] underline mt-1 inline-block"
                      >
            ...
            <div className="text-center mt-6 space-y-2">
              ...
              >
                Need a new link? Forgot password
              </Link>
              <Link
                href="/auth/login"
