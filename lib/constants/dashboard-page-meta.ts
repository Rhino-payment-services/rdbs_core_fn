...
export const DASHBOARD_PAGE_CRUMBS: Record<string, DashboardBreadcrumbItem[]> = {
  ...
  'merchant-events/orders/[ref]': [
    root,
    { label: 'Merchant Events', href: '/dashboard/merchant-events' },
    { label: 'Orders', href: '/dashboard/merchant-events/orders' },
    { label: 'Order Detail' },
  ],
  'merchant-events/support': [root, { label: 'Merchant Events', href: '/dashboard/merchant-events' }, { label: 'Support' }],
  'merchant-events/reports': [root, { label: 'Merchant Events', href: '/dashboard/merchant-events' }, { label: 'Revenue Report' }],
