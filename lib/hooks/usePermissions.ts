...
export const usePermissions = (): UsePermissionsReturn => {
  ...
  // Role-based permission defaults — these act as the FLOOR.
  // Users always receive at least their role's default permissions regardless
  // of what is (or isn't) stored in their session's explicit permission list.
  const roleDefaults: Record<Role, Permission[]> = {
    ...
    ADMIN: [
      ...
      PERMISSIONS.MERCHANT_EVENTS_VIEW, PERMISSIONS.MERCHANT_EVENTS_MANAGE,
      ...
      PERMISSIONS.TARIFF_VIEW, PERMISSIONS.TARIFF_CREATE, PERMISSIONS.TARIFF_UPDATE, PERMISSIONS.TARIFF_DELETE,
      PERMISSIONS.TARIFF_APPROVE, PERMISSIONS.TARIFF_REJECT,
    ...
    MANAGER: [
      ...
      PERMISSIONS.TARIFF_VIEW, PERMISSIONS.TARIFF_APPROVE, PERMISSIONS.TARIFF_REJECT,
