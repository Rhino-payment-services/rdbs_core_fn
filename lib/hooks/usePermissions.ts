...
export const PERMISSIONS = {
  ...
  // Tariff Management
  TARIFFS_VIEW: 'TARIFF_VIEW',
  TARIFFS_CREATE: 'TARIFF_CREATE',
  TARIFFS_UPDATE: 'TARIFF_UPDATE',
  TARIFFS_DELETE: 'TARIFF_DELETE',
  TARIFFS_APPROVE: 'TARIFF_APPROVE',
  TARIFFS_REJECT: 'TARIFF_REJECT',
